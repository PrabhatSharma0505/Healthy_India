...
{
    public partial class DowloadVaccine : System.Web.UI.Page
    {
            ...
            if (!string.IsNullOrEmpty(userEmail))
            {
                try
                {
                    ...
                    MailMessage message = new MailMessage
                    {
                        ...
                        Subject = "Vaccine Appointment Confirmation",
                        Body = "Your vaccine appointment has been successfully booked."
                    };
                    ...
                    litMessage.Text = "Vaccine appointment confirmation email sent successfully!";
                }
                catch (Exception ex)
                {
