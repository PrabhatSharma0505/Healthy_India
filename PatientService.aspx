<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PatientService.aspx.cs" Inherits="hospitalWebsite.PatientService" %>
    ...
    <main>
        <section id="about">
            <div class="container">
                ...
                <img src="https://images.unsplash.com/photo-1579684385127-1ef15d508118?q=80&w=1480&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D/800x400" alt="Hospital Image">
            </div>
        </section>
        <section id="services">
            <div class="container">
        ...
        <section id="contact">
            <div class="container">
                <h2>Contact Us</h2>
                <p>If you have any questions or need to schedule an appointment, please contact us at (+91) 99999-99999 or email us at contact@hospital.com.</p>
            </div>
        </section>
    </main>
    <footer>
